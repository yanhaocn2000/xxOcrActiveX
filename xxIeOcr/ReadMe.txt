========================================================================
    ACTIVEX 控件 DLL : xxIeOcr 项目概述
========================================================================

控件向导已为 xxIeOcr ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 xxIeOcr ActiveX 控件 DLL 的每个文件的内容。
...
xxIeOcrCtrl.h
    此文件包含 CxxIeOcrCtrl C++ 类的声明。

xxIeOcrCtrl.cpp
    此文件包含 CxxIeOcrCtrl C++ 类的实现。

xxIeOcrPropPage.h
    此文件包含 CxxIeOcrPropPage C++ 类的声明。

xxIeOcrPropPage.cpp
    此文件包含 CxxIeOcrPropPage C++ 类的实现。

CxxIeOcrCtrl.bmp
    此文件包含一个位图，当 CxxIeOcrCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 xxIeOcr.pch 的预编译头 (PCH) 文件和名为 
